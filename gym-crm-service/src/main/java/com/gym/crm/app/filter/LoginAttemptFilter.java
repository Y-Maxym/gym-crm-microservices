...
public class LoginAttemptFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        CustomContentCachingRequestWrapper requestWrapper = (CustomContentCachingRequestWrapper) request;
    ...
    private void writeForbiddenResponse(HttpServletResponse response) throws IOException {
        ...
        ErrorResponse error = new ErrorResponse(ErrorCode.TOO_MANY_FAILED_LOGIN_ATTEMPTS.getCode(), LoginAttemptFilter.TOO_MANY_ATTEMPTS_ERROR_MESSAGE);
